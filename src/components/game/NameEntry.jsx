...
export default function NameEntry({ onSubmit }) {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col items-center gap-4 sm:gap-6 md:gap-8 max-w-md w-full px-4"
    >
      ...
      <form onSubmit={handleSubmit} className="w-full space-y-3 sm:space-y-4">
        ...
        <Button
          type="submit"
          disabled={!name.trim()}
          className="w-full h-12 sm:h-14 text-lg sm:text-xl font-bold bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white shadow-lg disabled:opacity-50"
        >
          {t('letsPlay')}
        </Button>
      </form>
